...
public class ImageUpload1 extends javax.swing.JFrame {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {                                        
        ...
        String connectionURL = "jdbc:mysql://localhost:3306/jeedb";
        ...
        try {
           ...
           // parameters of string type connection url, user name and password to 
            ...
            psmnt = connection.prepareStatement("update student set image=? where rollno="+x);
          ...
          //  psmnt.setString(1, "Abir");
           ...
           // psmnt.setInt(2, x);
            ...
            connection.close();
            psmnt.close();
            Register rst1 = new Register();
            rst1.setVisible(true);
            setVisible(false);
